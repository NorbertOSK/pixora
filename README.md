...
Built by [Norberto Krucheski](https://norbertok.com).
...
| **macOS** (M1 and later) | [⬇ Download for macOS (.dmg)](https://github.com/NorbertOSK/pixora/releases/latest) |
...
> **macOS note:** If macOS says the app is "damaged", run this in Terminal and try again:
> ```bash
...
- [WebView2](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) (already included in Windows 11)
...
| Layer | Technology |
|---|---|
| Desktop framework | [Tauri 2](https://tauri.app/) — Rust + native WebView |
...
Made by [Norbert OK](https://norbertok.com)
