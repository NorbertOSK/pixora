...
Feito por [Norberto Krucheski](https://norbertok.com).
...
| **macOS** (M1 em diante) | [⬇ Baixar para macOS (.dmg)](https://github.com/NorbertOSK/pixora/releases/latest) |
...
> **Nota para macOS:** Se o sistema disser que o app está "danificado", execute este comando no Terminal e tente novamente:
> ```bash
...
- [WebView2](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) (já incluído no Windows 11)
...
| Camada | Tecnologia |
|---|---|
| Framework desktop | [Tauri 2](https://tauri.app/) — Rust + WebView nativo |
...
Feito por [Norbert OK](https://norbertok.com)
