...
Hecho por [Norberto Krucheski](https://norbertok.com).
...
| **macOS** (M1 en adelante) | [⬇ Descargar para macOS (.dmg)](https://github.com/NorbertOSK/pixora/releases/latest) |
...
> **Nota para macOS:** Si el sistema dice que la app está "dañada", ejecutá esto en la Terminal y volvé a intentarlo:
> ```bash
> xattr -cr /Applications/Pixora.app
> ```
...
- [Bun](https://bun.sh/) (gestor de paquetes y runner de scripts)
...
- [WebView2](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) (ya incluido en Windows 11)
...
| Capa | Tecnología |
|---|---|
| Framework de escritorio | [Tauri 2](https://tauri.app/) — Rust + WebView nativo |
...
Hecho por [Norbert OK](https://norbertok.com)
