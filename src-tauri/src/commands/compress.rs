...
fn decode(data_url: &str) -> Result<(DynamicImage, String, usize), String> {
...
#[tauri::command]
pub fn compress_image(data_url: String, options: CompressOptions) -> Result<CompressResult, String> {
...
#[tauri::command]
pub fn get_image_info(data_url: String) -> Result<ImageInfo, String> {
    let (header, data) = data_url
        .split_once(',')
        .ok_or_else(|| "URL inválida".to_string())?;
